/**
 * Sticky CTA Button
 * Shows a floating "Request Demo" button after user scrolls down
 */
...
(function() {
  ...
  function createStickyCTA() {
    ...
    stickyDiv.innerHTML = `
      <a href="/contact/" class="btn" aria-label="Request a demo">
    ...
    let scrollThreshold = 400; // Show after 400px scroll
    let isVisible = false;
